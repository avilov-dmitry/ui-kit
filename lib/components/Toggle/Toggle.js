...
exports.Toggle = react_1.memo(function (_a) {
    var _b, _c;
    ...
    return (react_1.default.createElement("div", { className: classnames_1.default(CLASS_NAME + "__wrapper") },
        Boolean(leftText) && react_1.default.createElement("span", { className: classnames_1.default(CLASS_NAME + "__leftText", leftTextClassName) }, leftText),
        react_1.default.createElement("button", { id: id, className: classnames_1.default(CLASS_NAME, (_b = {},
                _b[CLASS_NAME + "--isDisabled"] = isDisabled,
                _b[CLASS_NAME + "--isActive"] = value,
                _b), className), onClick: handleClick, disabled: isDisabled },
            react_1.default.createElement("span", { className: classnames_1.default(CLASS_NAME + "__thumb", (_c = {},
                    _c[CLASS_NAME + "__thumb--isActive"] = value,
                    _c), thumbClassName) })),
        Boolean(rightText) && react_1.default.createElement("span", { className: classnames_1.default(CLASS_NAME + "__rightText", rightTextClassName) }, rightText)));
});
