...
var Toggle = function (_a) {
    ...
    return (react_1.default.createElement("div", { className: bind_1.default(CLASS_NAME + "__wrapper") },
        Boolean(leftText) && react_1.default.createElement("span", { className: bind_1.default(CLASS_NAME + "__leftText", leftTextClassName) }, leftText),
        react_1.default.createElement("button", { id: id, className: bind_1.default(CLASS_NAME, (_b = {},
                _b[CLASS_NAME + "--isDisabled"] = isDisabled,
                _b[CLASS_NAME + "--isActive"] = value,
                _b), className), onClick: handleClick, disabled: isDisabled },
            react_1.default.createElement("span", { className: bind_1.default(CLASS_NAME + "__thumb", (_c = {},
                    _c[CLASS_NAME + "__thumb--isActive"] = value,
                    _c), thumbClassName) })),
        Boolean(rightText) && react_1.default.createElement("span", { className: bind_1.default(CLASS_NAME + "__rightText", rightTextClassName) }, rightText)));
};
