...
exports.Textarea = react_1.memo(function (_a) {
    ...
    return (react_1.default.createElement(react_1.default.Fragment, null,
        react_1.default.createElement("div", { className: bind_1.default(CLASS_NAME + "__wrapper", className) },
            react_1.default.createElement("span", { className: bind_1.default(CLASS_NAME + "__label", (_b = {},
                    _b[CLASS_NAME + "__label--isVisibleLabel"] = isVisibleLabel,
                    _b)), onClick: handleClickOnLabel }, label),
            react_1.default.createElement("textarea", { ref: textareaRef, className: bind_1.default(CLASS_NAME), id: id, value: value, rows: 1, disabled: isReadOnly, onChange: handleChange, 
