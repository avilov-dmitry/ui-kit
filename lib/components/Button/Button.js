...
exports.Button = react_1.memo(function (_a) {
    ...
    return (react_1.default.createElement("button", { id: id, className: classnames_1.default(CLASS_NAME, (_b = {},
        ...
        react_1.default.createElement(react_1.default.Fragment, null,
            LeftIcon && react_1.default.createElement("span", { className: classnames_1.default(CLASS_NAME + "__icon--left") },
            ...
            RightIcon && react_1.default.createElement("span", { className: classnames_1.default(CLASS_NAME + "__icon--right") },
