...
var Button = function (_a) {
    ...
    return (react_1.default.createElement("button", { id: id, className: bind_1.default(CLASS_NAME, (_b = {},
        ...
        react_1.default.createElement(react_1.default.Fragment, null,
            LeftIcon && react_1.default.createElement("span", { className: bind_1.default(CLASS_NAME + "__icon--left") },
                react_1.default.createElement(LeftIcon, null)),
            text && react_1.default.createElement("span", { className: bind_1.default(CLASS_NAME + "__text") }, text),
            RightIcon && react_1.default.createElement("span", { className: bind_1.default(CLASS_NAME + "__icon--right") },
