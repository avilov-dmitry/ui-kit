...
var Drop = /** @class */ (function (_super) {
    ...
    Drop.prototype.render = function () {
        ...
        return (React.createElement("div", { className: classnames_1.default(CLASS_NAME), ref: this.wrapperRef },
            React.createElement("button", { className: classnames_1.default(CLASS_NAME + "__control-wrapper"), ref: this.controlRef, type: "button", onClick: this.handleOnControl }, control),
            React.createElement("div", { className: classnames_1.default(CLASS_NAME + "__dropdown-wrapper"), ref: this.dropdownRef, style: wrapperStyles }, dropdown)));
    };
    return Drop;
}(React.PureComponent));
exports.Drop = Drop;
