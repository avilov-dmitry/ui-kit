...
var Input = function (_a) {
    ...
    return (react_1.default.createElement(react_1.default.Fragment, null,
        react_1.default.createElement("div", { className: bind_1.default(CLASS_NAME + "__wrapper", (_b = {}, _b[CLASS_NAME + "__wrapper--isFullWidth"] = isFullWidth, _b), className) },
            react_1.default.createElement("span", { className: bind_1.default(CLASS_NAME + "__label", (_c = {},
                    _c[CLASS_NAME + "__label--isVisibleLabel"] = isVisibleLabel,
                    _c)), onClick: handleClickOnLabel }, label),
            react_1.default.createElement("input", { ref: inputRer, className: bind_1.default(CLASS_NAME), id: id, type: "text", value: value, disabled: isReadOnly, onChange: handleChange, onFocus: handleFocus, onBlur: handleBlur })),
        Boolean(error) && react_1.default.createElement("span", { className: bind_1.default(CLASS_NAME + "__error") }, error)));
};
exports.Input = Input;
