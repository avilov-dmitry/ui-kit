...
exports.Input = react_1.memo(function (_a) {
    var _b, _c;
    ...
    return (react_1.default.createElement(react_1.default.Fragment, null,
        react_1.default.createElement("div", { className: classnames_1.default(CLASS_NAME + "__wrapper", (_b = {}, _b[CLASS_NAME + "__wrapper--isFullWidth"] = isFullWidth, _b), className) },
            react_1.default.createElement("span", { className: classnames_1.default(CLASS_NAME + "__label", (_c = {},
                    _c[CLASS_NAME + "__label--isVisibleLabel"] = isVisibleLabel,
                    _c)), onClick: handleClickOnLabel }, label),
            react_1.default.createElement("input", { ref: inputRer, className: classnames_1.default(CLASS_NAME), id: id, type: "text", value: value, disabled: isReadOnly, onChange: handleChange, onFocus: handleFocus, onBlur: handleBlur })),
        Boolean(error) && react_1.default.createElement("span", { className: classnames_1.default(CLASS_NAME + "__error") }, error)));
});
